...
//           this.echo(
//             "Press ` to minimize the terminal. The available commands are:"
//           )
//           this.echo(
//             "[[b;red;black;]cd], [[b;red;black;]ls], [[b;red;black;]cat], [[b;red;black;]open], (to open .pdf and .jpg files)"
//           )
//           callback()
//         },
//         keypress: function (e) {
...
//       var self = this
//       self.terminal = this.find(".td").terminal(ev, settings)
//       var focus = false
